                ...
                for (let j = resellers.length - 1; j >= 0; j--) {
                    if(resellers[i].short_id == resellers[j].short_id){
                        if (navhtml === ''){
                            ...
                            navhtml = navhtml + '<p class="nav-text-modif nav-text">'+ resellers[j].full_name +'</p><p class="nav-text">'+ resellers[j].address +'<br></p>' + '<p class="nav-text">' + resellers[j].phone + `${resellers[i].email?'<br><a href="mailto:' + resellers[i].email + '">' + resellers[i].email + '</a>':""}<br>${resellers[j].website?'<a href="' + resellers[j].website + '" target="_blank" rel="noopener">' + resellers[j].website.replace("https://","") + '</a>':""}</p>`;
                        }else{
                            navhtml = navhtml + '<div class="flex_change nav_txt" style="display:flex; flex-direction: row;"><div style="min-width:50%; padding-left:25px;">'
                            navhtml = navhtml + '<br><p class="nav-text-modif nav-text">'+ resellers[j].full_name +'</p><p class="nav-text">'+ resellers[j].address +'<br></p>' + '<p class="nav-text">' + resellers[j].phone + `${resellers[i].email?'<br><a href="mailto:' + resellers[i].email + '">' + resellers[i].email + '</a>':""}<br>${resellers[j].website?'<a href="' + resellers[j].website + '" target="_blank" rel="noopener">' + resellers[j].website.replace("https://","") + '</a>':""}<p>`;
                        }
